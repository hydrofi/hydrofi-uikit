...
export const TokenImages: React.FC = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `https://hydrofi.hdgneconomy.io/images/tokens/${token.address[56]}.svg`;
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `https://hydrofi.hdgneconomy.io/images/tokens/${token.address[56]}.svg`;
        const secondarySrc = `https://hydrofi.hdgneconomy.io/images/tokens/${tokens[randomTokenIndex].address[56]}.svg`;
