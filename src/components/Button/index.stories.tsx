...
export const Anchors: React.FC = () => {
  return (
    <>
      ...
      <Box>
        <Button as="a" href="https://hydrofi.hdgneconomy.io" mr="8px" external disabled>
          Disabled
        </Button>
        <Button as="a" href="https://hydrofi.hdgneconomy.io" variant="secondary" external disabled>
          Disabled
        </Button>
      </Box>
    </>
